...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, AdapterView.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public Loader<Cursor> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        if (id == CONTACT_LOAD) {
            ...
            mCursorLoader = new CursorLoader(MainActivity.this,
                    ...
                    ContactsContract.Contacts.HAS_PHONE_NUMBER + "=1",null, ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME + " ASC");
            ...
            mCursorLoader = new CursorLoader(MainActivity.this,
                    ...
                    ContactsContract.CommonDataKinds.Phone.CONTACT_ID + " = ? AND " +ContactsContract.CommonDataKinds.Phone.TYPE + " = " + ContactsContract.CommonDataKinds.Phone.TYPE_MOBILE + " AND " +
